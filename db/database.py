...
#                 print(json.dumps({"debug": "Processing note", "attributes": attributes}))
...
#                 # Additional check for missing created_by_account_id
#                 if adracare_account_id is None:
#                     print(json.dumps({
#                         "warning": "Missing created_by_account_id in note attributes",
#                         "note_id": note.get("id")
#                     }))
#                     return inserted_timestamps
